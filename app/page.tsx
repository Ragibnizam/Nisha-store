      ...
      <main style={styles.main}>
        <section style={styles.hero}>
          ...
          <p style={styles.subtitle}>
            A clean Next.js starter. Tell me what you want to build and I'll turn it into a real product.
          </p>
        ...
        <section id="features" style={styles.features}>
          {[
            { title: "Fast", text: "Next.js with App Router and TypeScript." },
...
const styles: Record<string, React.CSSProperties> = {
  ...
  brandText: { fontWeight: 700, fontSize: 18, letterSpacing: -0.2 },
  nav: { display: "flex", gap: 20, alignItems: "center" },
  navLink: { color: "var(--text-muted)", fontWeight: 500, fontSize: 14 },
  navLinkCta: {
    color: "#fff",
  ...
  cardTitle: { margin: "0 0 8px", fontSize: 18, fontWeight: 600 },
  cardText: { margin: 0, color: "var(--text-muted)", fontSize: 15, lineHeight: 1.6 },
  cta: {
    textAlign: "center",
    padding: "48px 24px",
    borderRadius: 20,
  ...
  ctaTitle: { fontSize: 28, margin: "0 0 8px", fontWeight: 700 },
  ctaText: { margin: 0, opacity: 0.9 },
  footer: {
    padding: "24px 0",
    textAlign: "center",
    color: "var(--text-muted)",
